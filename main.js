...
let button = document.getElementById('sa-start');
let process = document.getElementById('sa-process');
let controller = document.getElementById('sa-controller');
let container = document.querySelector('.sa-container');
let info = document.querySelector('.sa-info');


document.addEventListener('DOMContentLoaded', function() {
  // Document Ready
  
  svg = SVG().addTo('#sa-art').size(SIZE + 20, SIZE + 20)
...
function drawImageToCanvas(){
  ...
  img.onload = function(){
    const c = document.getElementById('sa-image');
